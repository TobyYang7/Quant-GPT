...
def retriever(query, embedding_model, df_news, score_weight=[0.7, 0.3], top_k=5):
    ...
    dense_vecs = df_news['dense_vecs'].to_numpy()
    ...
    for i in range(len(dense_vecs)):
        ...
        score_lexical = model.compute_lexical_matching_score(query_embedding['lexical_weights'], lexical_weights['lexical_weights'][i])
...
if __name__=="__main__":
    ...
    reranking_model = FlagReranker('/home/JQpeng/workspace/bge-reranker-large', use_fp16=True)
