...
parquet_file = pq.ParquetFile('../data/announcement/processed_LLM_data_1_10_30_32k.parquet')
...
pq.write_table(table, '../data/announcement/processed_LLM_data_train_1_10_30_32k.parquet')
table = pa.Table.from_pandas(LLM_data_test)
pq.write_table(table, '../data/announcement/processed_LLM_data_test_1_10_30_32k.parquet')
# %%
